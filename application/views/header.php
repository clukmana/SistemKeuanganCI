  ...
  <div class="container-scroller">
    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row bg-success">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center bg-success">
          <a class="navbar-brand brand-logo" href="<?php echo base_url() ?>">Sistem Keuangan Desa</a>
...
<div id="id01" class="w3-modal">
 <div class="w3-modal-content w3-card-4 w3-animate-zoom">
  ...
  <div class="w3-bar w3-border-bottom">
   <button class="tablink w3-bar-item w3-button text-danger" onclick="openCity(event, 'London')"><b>Transaksi Pengeluaran</b></button>
   <button class="tablink w3-bar-item w3-button text-dark" onclick="openCity(event, 'Paris')"><b>Transaksi Pemasukan</b></button>
...
<br>
         ...
         {  
           ...
           ?>  
                      ...
                      <option disabled="">Penerima tidak ditemukan</option> 
           ...
           ?> 
                    ...
                    <div class="form-group">
                      ...
                      <input name="discription" autocomplete="off" type="text" class="form-control form-control-sm" id="exampleInputPassword1" placeholder="Keterangan">
                    </div>
                    <div class="form-group">
                    <label>Jumlah</label>
                    ...
                    <div class="form-group">
                    <label for="exampleFormControlSelect3">Jenis Pengeluaran</label>
                    <select required="" name="item" class="form-control form-control-sm" id="exampleFormControlSelect3">
                      ...
                      <button type="submit" name="debit" class="btn btn-gradient-primary mr-2 btn-sm ">Tambah</button>
                    <button type="reset" class="btn btn-sm btn-light">Hapus</button>
                  </form>
   ...
   <form class="forms-sample" method="post" action="<?php echo base_url() ?>/Home/add_credit">
         ...
         {  
           ...
           ?> 
                    ...
                    <div class="form-group">
                      <label for="exampleInputPassword1">Keterangan</label>
                      <input name="discription" type="text" class="form-control form-control-sm" id="exampleInputPassword1" placeholder="Keterangan">
                    </div>
                    <div class="form-group">
                    <label>Jumlah</label>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlSelect3">Jenis Pemasukan</label>
                    <select required="" name="item" class="form-control form-control-sm" id="exampleFormControlSelect3">
                        <option disabled selected>Pilih..</option>
                        <option value="Pembiayaan Desa">Pembiayaan Desa</option>
                        <option value="Belanja Desa">Belanja Desa</option>
       ...
       <button type="submit" name="credit" class="btn btn-gradient-primary mr-2 btn-sm ">Tambah</button>
                     <button type="reset" class="btn btn-sm btn-light">Hapus</button>
                  </form>
  </div>
     </div>
        ...
        <ul class="nav">
          ...
          <li class="nav-item bg-dark">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>Home/add_client">Tambah Data</a></li>
                       <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>Home/view_clients">Master Data</a></li>
          ...
          <li class="nav-item sidebar-actions">
            <span class="nav-link">
              ...
              <button  onclick="document.getElementById('id01').style.display='block'" class="btn btn-block btn-lg btn-gradient-dark mt-4">Tambah Transaksi </button>
