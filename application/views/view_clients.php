            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                    ...
                    <br>
                  <h2 class="card-title text-primary">Master Data</h2>
...
<a class="btn btn-danger btn-sm" href="<?php echo  base_url() ?>Home/view_clients?del=<?php echo $row->id ?>" onclick="return confirm('Apakah anda yakin ingin meghapus data ini ?');" aria-label="Delete">
  <i class="fa fa-trash-o" aria-hidden="true"></i>
           ...
           ?>  
                   ...
                   <tr><td>Penerima Tidak Ditemukan</td></tr> 
