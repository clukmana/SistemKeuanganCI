...
<div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-primary">Profil Customer</h5>
...
<div class="tab">
  <button class="tablinkss " onclick="openCityy(event, 'debit')" id="defaultOpen">Pengeluaran</button>
...
//                       $sum_texte .= " Excess Amount ";
 ...
 elseif($sum===0) {
     $sum_text="Hurray!!......No Dues!";
           ...
           ?> 
                    <h5 class="text-success">Pengeluaran:Rp. <?php echo $row->dtotal ?></h5>
                    <h5 class="text-success">Jumlah diterima:Rp. <?php echo $row->ctotal ?></h5>
                    <h5 class="text-danger">Jumlah jatuh tempo: Rp. <?php echo $sum_text?>/-</h5>
                     <h5 class="text-warning">Jumlah surplus: Rp. <?php echo $sum_texte?>/-</h5>
                    <?php       
             }  
          }  
          else  
