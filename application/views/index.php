               ...
               foreach($expense->result() as $row)  
                {  
                 ...
                 <?php }    
                  ...
                  <h1 class="mb-5">Rp. <?php echo  $row->E ?></h1>
                  <?php }?>
...
<!--                  <h6 class="card-text">Increased by 60%</h6>-->
            ...
            <div class="col-md-6 stretch-card grid-margin">
              <div class="card bg-gradient-success card-img-holder text-white">
                <div class="card-body">
                  <img src="<?php echo base_url() ?>assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image"/>
                  <h4 class="font-weight-normal mb-3"> Jumlah Pemasukan
               ...
               foreach($income->result() as $row)  
                {  
                 ...
                 <?php  if($row->I===NULL){ ?>
                     <h1 class="mb-5">Tidak ada pemasukan hari ini!</h1>
                 <?php }    
                  else{ ?>
                  <h1 class="mb-5">Rp. <?php echo  $row->I ?></h1>
                  <?php }?>
...
-->
          ...
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title text-primary">Pengeluaran terbaru</h4>
         ...
         {  
           ...
           ?> 
                        <tr>
                          ...
                          <a class="btn btn-danger btn-sm" href="<?php echo base_url() ?>/Home/add_debit?del=<?php echo $row->deb_id ?>"  aria-label="hapus" onclick="return confirm('Apakah anda yakin menghapus ini?');">
    ...
    <div class="w3-modal-content">
      ...
      <div class="w3-container">
       <form class="forms-sample" method="post" action="<?php echo base_url() ?>/Home/add_debit?id=<?php echo $row->deb_id ?>&del_id=<?php echo $row->id ?> ">
                    ...
                    <select required="" name="item" class="form-control form-control-sm" id="exampleFormControlSelect3">
                      ...
                      <button type="submit" name="update_debit" class="btn btn-gradient-primary mr-2 btn-sm ">Perbarui</button>
                ...
                <footer class="w3-container w3-sand">
                    ...
                    ?>  
                                ...
                                Tidak ada Pengeluaran ditemukan!</div></td>   
                                  </tr>
                    <?php  
                    }  
                    ?> 
      ...
      <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title text-primary">Jumlah diterima terbaru </h4>
                  <div class="table-responsive" >
                   <table id="example" class="table">
                      <thead>
                        <tr>
                        ...
                        <div class="w3-modal-content">
                          ...
                          <form class="forms-sample" method="post" action="<?php echo base_url() ?>/Home/add_credit?id=<?php echo $row->cre_id ?>&del_id=<?php echo $row->id ?> ">
                                        ...
                                        <input name="amount" onkeypress="return isNumber(event)" value="<?php echo $row->amount ?>" type="text" class="form-control form-control-sm" placeholder="Debit Amount" aria-label="Debit Amount">
                                          ...
                                          <button type="submit" name="update_credit" class="btn btn-gradient-primary mr-2 btn-sm ">Perbarui</button>
                                        <button type="reset" class="btn btn-sm btn-light">Hapus</button>
                                      </form>
                          </div>
                          <footer class="w3-container w3-sand">
